...
function onClick( event ){
	...
	for( var i in countryColorMap ){
		...
		if( pickColorIndex == countryColorIndex ){
			...
			//console.log("converts to " + countryLookup);
			...
			//console.info(selection.getExportCategories());
			...
			selectVisualization( timeBins, selection.selectedYear, [selection.selectedCountry], source_list, target_list );	
