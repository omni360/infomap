...
function loadImage() {
    ...
    img.src = "assets/images/map_small.jpg";
...
function init() {
    ...
    uniforms = {
        ...
        texture:   { type: "t", value: THREE.ImageUtils.loadTexture( "assets/images/dot.png" ) },
    ...
    var outerMaterial = new THREE.ParticleBasicMaterial( { map: THREE.ImageUtils.loadTexture( "assets/images/hex.png" ), opacity: 0.0, size: 3, transparent: true, alphaTest: 0.5 } );
