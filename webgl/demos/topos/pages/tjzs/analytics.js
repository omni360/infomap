...
window.onload = function () {
    ...
    label.hide();
    var frame = r.popup(100, 100, label, "right").attr({fill: "#000", stroke: "#fffff0000", "stroke-width": 2, "fill-opacity": .7}).hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        var dot = r.circle(x, y, 3).attr({fill: "#333", stroke: color, "stroke-width": 2});
