        ...
        if (rayVector == undefined){
        	...
        	if (this.mouseDownButton == 0){
    			...
    			if (this.multiObjs[rayVector.uid] == undefined ){
    				mark = new Space3D.Mark({map: Space3D.TexturesLibrary['MultiMark'], position: rayVector});
	    			mark.visible = true;
...
OOPTEST.System.prototype.initSpace3D = function (complateFun){
	...
	*/
	var gyroscope_viewport = this.gyroscope_viewport = new Space3D.Viewport({
		fov: 45, near: 1, far: 30000, bottom: 218, right: 107, width: 100, height: 80, 
		controler: true, clearColor: 0x1D2A36, target: gyroscope.position, scene: scene
	});
...
OOPTEST.System.prototype.update = function (topo_info){
