...
function draw_statistics_div(raphael, world_statis){
    ...
    draw_hexagon(raphael, start_cx + 50, start_cy , 30, "#4272A1", "", text_color);
    ...
    draw_hexagon(raphael, start_cx, start_cy + 63 , 30, "#4272A1", "", text_color);
    ...
    draw_hexagon(raphael, start_cx + 50, start_cy + 130 , 30, "#5EAC9D", "", text_color);
    ...
    draw_hexagon(raphael, start_cx + 260, start_cy , 30, "#5EAC9D", "", text_color);
    ...
    draw_hexagon(raphael, start_cx + 310, start_cy + 63 , 30, "#565980", "", text_color);
    ...
    draw_hexagon(raphael, start_cx + 260, start_cy + 130 , 30, "#565980", "", text_color);
    ...
    raphael.text(start_cx + 158, start_cy + 57, "").attr({fill: "#eeffff", "font-size":12, "font-weight": "bold", "font-family": "微软雅黑"});
