        ...
        */
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            if(data_list[i][1]){
                ...
                particle_colors1.push(new THREE.Color( sys_1_color ));
                particle_size1.push(1);
                particle_geometry1.vertices.push(  endPosition  );
                
                
                var line_material1 = new THREE.LineBasicMaterial( { color: sys_1_color, opacity: 0.6, linewidth: 2 } );
                var line_geometry1 =  new THREE.Geometry();
                line_geometry1.vertices.push(  startPosition  );
                line_geometry1.vertices.push(  endPosition  );
            ...
            if(data_list[i][2]){
                ...
                this.line_li.push(line_data);
                particle_colors1.push(new THREE.Color( sys_2_color ));
                particle_size1.push(1);
                particle_geometry1.vertices.push(  endPosition  );
                
                
                var line_material1 = new THREE.LineBasicMaterial( { color: sys_2_color, opacity: 0.6, linewidth: 2 } );
                var line_geometry1 =  new THREE.Geometry();
                line_geometry1.vertices.push(  startPosition  );
                line_geometry1.vertices.push(  endPosition  );
                var line1 = new THREE.Line( line_geometry1, line_material1 );
            ...
            if(data_list[i][3]){
                ...
                this.line_li.push(line_data);
                particle_colors1.push(new THREE.Color( sys_3_color ));
                particle_size1.push(1);
                particle_geometry1.vertices.push(  endPosition  );
                
                
                var line_material1 = new THREE.LineBasicMaterial( { color: sys_3_color, opacity: 0.6, linewidth: 2 } );
                var line_geometry1 =  new THREE.Geometry();
                line_geometry1.vertices.push(  startPosition  );
                line_geometry1.vertices.push(  endPosition  );
                var line1 = new THREE.Line( line_geometry1, line_material1 );
            ...
            if(data_list[i][8]){
                ...
                this.line_li.push(line_data);
                particle_colors1.push(new THREE.Color( sys_4_color ));
                particle_size1.push(1);
                particle_geometry1.vertices.push(  endPosition  );
                
                
                var line_material1 = new THREE.LineBasicMaterial( { color: sys_4_color, opacity: 0.6, linewidth: 2 } );
                var line_geometry1 =  new THREE.Geometry();
                line_geometry1.vertices.push(  startPosition  );
                line_geometry1.vertices.push(  endPosition  );
                var line1 = new THREE.Line( line_geometry1, line_material1 );
