...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadChinaModel = function(geometryQuads){
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            if(data_list[i][1]){
                line_geometry1.vertices.push(  new THREE.Vector3( cx, cy, -17740 )  );
                line_geometry1.vertices.push(  sys_1_position  );
            }
            if(data_list[i][2]){
                line_geometry2.vertices.push(  new THREE.Vector3( cx, cy, -17740 )  );
                line_geometry2.vertices.push(  sys_2_position  );
            }
            if(data_list[i][3]){
                line_geometry3.vertices.push(  new THREE.Vector3( cx, cy, -17740 )  );
                line_geometry3.vertices.push(  sys_3_position  );
            }
            if(data_list[i][8]){
                line_geometry4.vertices.push(  new THREE.Vector3( cx, cy, -17740 )  );
                line_geometry4.vertices.push(  sys_4_position  );
            }
        }
        
        var line_material1 = new THREE.LineBasicMaterial( { color: 0xffff00, opacity: 1, linewidth: 2 , dashSize: 10, gapSize: 10} );
        var line1 = new THREE.Line( line_geometry1, line_material1 , THREE.LinePieces);
        this.scene.add( line1 );
        
        var line_material2 = new THREE.LineBasicMaterial( { color: 0x0000ff, opacity: 1, linewidth: 2 , dashSize: 10, gapSize: 10} );
        var line2 = new THREE.Line( line_geometry2, line_material2 , THREE.LinePieces);
        this.scene.add( line2 );
        
        var line_material3 = new THREE.LineBasicMaterial( { color: 0x00ff00, opacity: 1, linewidth: 2 , dashSize: 10, gapSize: 10} );
        var line3 = new THREE.Line( line_geometry3, line_material3 , THREE.LinePieces);
        this.scene.add( line3 );
        
        var line_material4 = new THREE.LineBasicMaterial( { color: 0x663399, opacity: 1, linewidth: 2 , dashSize: 10, gapSize: 10} );
        var line4 = new THREE.Line( line_geometry4, line_material4, THREE.LinePieces);
