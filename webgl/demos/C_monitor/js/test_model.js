...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        var sys_li = [
            ['恶意代码分析系统',           0,  0, 20000, "60"],
            ['蜜网系统',                   8700,  0, 8000, "60"],
            ['网站监测系统',               400, 0 , -7000, "60"],
            ['轻载扫描系统',               -10000, 0, -10000,"60"],
            ['路由监测系统',               10000,  0, -7000,    "60"],
            ['流监测系统',                 10000,      0, 0, "60"],
            ['域名监测系统',               -10000, 0, 0, "60"],
            ['协同联动系统',               0,      0, 0, "60"],
        ...
        for(i=0; i < sys_li.length; i++){
            ...
            sprite.position.set(sys_li[i][1],sys_li[i][2] + 4500,sys_li[i][3]);
    ...
    ClassTPlatform.prototype.initTubeAndMoveObjects = function(){
        ...
        // var sample_storage_obj_list = [
            // [[[-3000, 9640 , -10000], [-3000, 9640 , -8000], [-3000, 8640 , -5000], [-3000, 6640 , -5000], [-3000, 6640 , -1000]], 3 ],
            // [[[3700, 14000 , -10000], [3700, 14000 , -8000], [3700, 13000 , -5000], [3700, 11000 , -5000], [3700, 11000 , -1000]], 3 ],
            // [[[3400, 11000 , -10000], [3400, 11000 , -8000], [3400, 10000 , -5000], [3400, 8000 , -5000], [3400, 8000 , -1000]], 4 ],
            // [[[400, 8400 , -10000], [400, 8400 , -8000], [400, 7400 , -5000], [400, 5400 , -5000], [400, 5400 , -1000]], 4 ],
            // [[[3900, 7800 , -10000], [3900, 7800 , -8000], [3900, 6800 , -5000], [3900, 4800 , -5000], [3900, 4800 , -1000]], 3 ],
            // [[[5400, 16000 , -10000], [5400, 16000 , -8000], [5400, 15000 , -5000], [5400, 13000 , -5000], [5400, 13000 , -1000]], 3 ],
            // [[[-5000, 13500 , -10000], [-5000, 13500 , -8000], [-5000, 12500 , -5000], [-5000, 10500 , -5000], [-5000, 10500 , -1000]], 3 ],
        // ];
        /*
         * 数据汇聚到系统的管道
         */
        var sample_storage_obj_list = [
            ...
            [[[400, 7400 , -7000], [400, 3950 , -7000]], 4 ],
            
            // 报文监测和恶意代码捕获系统
            [[[-3000, 9640 , -10000], [-3000, 9640 , -8000]], 3 ],
            [[[-3000, 9640 , -8000], [-3000, 8640 , -7000]], 3 ],
            [[[-3000, 8640 , -7000], [-3000, 5000 , -7000]], 3 ],
            [[[-3000, 5000 , -7000], [-3000, 5000 , 15000]], 3 ],
            [[[-3000, 5000 , 15000], [-10000, 5000 , 15000]], 3 ],
            [[[-10000, 5000 , 15000], [-10000, 5000 , 10000]], 3 ],
            [[[-10000, 5000 , 10000], [-10000, 3950 , 10000]], 3 ],
            
            // 蜜网系统
            [[[4170, 13400 , -10000], [4170, 13400 , -8000]], 3 ],
            [[[4170, 13400 , -8000], [4170, 12400 , -7000]], 3 ],
            [[[4170, 12400 , -7000], [4170, 5000 , -7000]], 3 ],
            [[[4170, 5000 , -7000], [4170, 5000 , 8000]], 3 ],
            [[[4170, 5000 , 8000], [8700, 5000 , 8000]], 3 ],
            [[[8700, 5000 , 8000], [8700, 3950 , 8000]], 3 ],
            
            // 路由监测系统
            [[[6900, 16100 , -10000], [6900, 16100 , -8000]], 3 ],
            [[[6900, 16100 , -8000], [6900, 15100 , -7000]], 3 ],
            [[[6900, 15100 , -7000], [6900, 5000 , -7000]], 3 ],
            [[[6900, 5000 , -7000], [10000, 5000 , -7000]], 3 ],
            [[[10000, 5000 , -7000], [10000, 3950 , -7000]], 3 ],
            
            // 流监测系统
            [[[5400, 9800 , -10000], [5400, 9800 , -8000]], 3 ],
            [[[5400, 9800 , -8000], [5400, 8800 , -7000]], 3 ],
            [[[5400, 8800 , -7000], [5400, 5000 , -7000]], 3 ],
            [[[5400, 5000 , -7000], [5400, 5000 , 0]], 3 ],
            [[[5400, 5000 , 0], [10000, 5000 , 0]], 3 ],
            [[[10000, 5000 , 0], [10000, 3950 , 0]], 3 ],
            ...
            [[[-7000, 5800 , 0], [-10000, 5800 , 0]], 4 ],
            [[[-10000, 5800 , 0], [-10000, 3950 , 0]], 4 ],
            
            // 轻载扫描系统
            [[[-5000, 13500 , -10000], [-5000, 13500 , -8000]], 3 ],
            [[[-5000, 13500 , -8000], [-5000, 12500 , -7000]], 3 ],
            [[[-5000, 12500 , -7000], [-5000, 5000 , -7000]], 3 ],
            [[[-5000, 5000 , -7000], [-5000, 5000 , -3000]], 3 ],
            [[[-5000, 5000 , -3000], [-10000, 5000 , -3000]], 3 ],
            [[[-10000, 5000 , -3000], [-10000, 5000 , -10000]], 3 ],
            [[[-10000, 5000 , -10000], [-10000, 3950 , -10000]], 3 ],
        ];
        ...
        var sample_storage_obj_list = [
            // 网站监测系统 -> 协同联动
            [[[0, 1500 , -5000], [0, 1500, -2000]], 4 ],
            
            // 轻载扫描系统 -> 协同联动
            [[[-10000, 1500 , -8000], [-10000, 1500 , -7000]], 4 ],
            [[[-10000, 1500 , -7000], [-3000, 1500 , -7000]], 4 ],
            [[[-3000, 1500 , -7000], [-3000, 1500, -1000]], 4 ],
            [[[-3000, 1500 , -1000], [-2000, 1500, -1000]], 4 ],
            
            // 域名监测系统 -> 协同联动
            [[[-8000, 1500 , 1000], [-2000, 1500, 1000]], 4 ],
            
            // 路由监测系统 -> 协同联动
            [[[8000,  1500, -7000], [3000,  1500, -7000]], 4 ],
            [[[3000,  1500, -7000], [3000,  1500, -1000]], 4 ],
            [[[3000,  1500, -1000], [2000, 1500, -1000]], 4 ],
            ...
            // 蜜网系统 -> 协同联动
            [[[8700,  1500, 6000], [8700,  1500, 3000]], 4 ],
            [[[8700,  1500, 3000], [1700,  1500, 3000]], 4 ],
            [[[1700,  1500, 3000], [1000,  1500, 2000]], 4 ],
            
            // 报文监测和恶意代码捕获系统 -> 协同联动
            [[[-10000,  1500, 8000], [-10000,  1500, 3000]], 4 ],
            [[[-10000,  1500, 3000], [-1700,  1500, 3000]], 4 ],
            [[[-1700,  1500, 3000], [-1000,  1500, 2000]], 4 ],
            
            // 恶意代码分析系统 -> 协同联动
            [[[0,  1500, 18000], [0,  1500, 2000]], 4 ],
            
            // 蜜网系统 -> 恶意代码分析系统
            [[[8700,  1500, 10000], [8700,  1500, 20000]], 4 ],
            [[[8700,  1500, 20000], [2000,  1500, 20000]], 4 ],
            
            // 报文监测和恶意代码捕获系统 -> 恶意代码分析系统
            [[[-10000,  1500, 12000], [-10000,  1500, 20000]], 4 ],
            [[[-10000,  1500, 20000], [-2000,  1500, 20000]], 4 ],
    ...
    ClassTPlatform.prototype.createTubeAndMoveObjects = function(obj_list, obj_color, obj_map, obj_num, obj_interval, tube_color, tube_segments, tube_radius, tube_radius_segments){
        ...
        for( var a = 0; a < obj_list.length; a ++ ) {
            ...
            this.addTubeGeometry( oo, tube_color , tube_segments, tube_radius, tube_radius_segments)
            /*
            startPosition = new THREE.Vector3(
                oo[0], oo[1], oo[2]
            );
            ...
            var distance = startPosition.distanceTo(endPosition);
            obj_num = distance / (this.moveSpeed * 20);
            if(obj_num < 1){
                obj_num = 1;
            }
            else{
                obj_num = Math.round(obj_num);
            }
            
            for ( var b = 0; b < obj_num; b ++ ) {
     ...
     * 添加管道对象
     */
    ClassTPlatform.prototype.addTubeGeometry = function( vector_li, color , segments, radius, radius_segments) {
        var li = vector_li[0];
        
        var path = []
        for(i=0; i < li.length; i++){
            //console.info(i);
            path.push(new THREE.Vector3( li[i][0], li[i][1], li[i][2] ));
        }
    ...
    ClassTPlatform.prototype.loadQingzaiSys = function(geometry){
        ...
        for(i=0; i < sys_li.length; i++){
            ...
            sample_storage1.scale.set( 1000, 300, 1000 );
            this.scene.add( sample_storage1 );
        }
        */
       var sys_color = 0x00ff00;
        ...
        sample_storage1.position.set(-25000,  0, 2000);
    ...
    ClassTPlatform.prototype.loadLiuSys = function(geometry){
       ...
       this.scene.add( sample_storage1 );
        ...
        var sys_obj = THREE.SceneUtils.createMultiMaterialObject( sys_geometry, sys_material );
        sys_obj.position.set( position_x - 500, position_y + 650 + 700 + 2500, position_z + 200);
        this.scene.add( sys_obj );
        
        // 线
        var lines_geometry = new THREE.Geometry();
        
        lines_geometry.vertices.push( new THREE.Vector3( position_x - 500, position_y + 650 + 700 + 2400, position_z + 200) );
    ...
    ClassTPlatform.prototype.loadWangzhanSys = function(geometry){
        ...
        var sys_geometry = new THREE.CubeGeometry(2000, 200, 2000);
        var sys_obj = THREE.SceneUtils.createMultiMaterialObject( sys_geometry, sys_material );
        sys_obj.position.set( position_x, position_y + 650 + 700 + 2500, position_z + 200);
        this.scene.add( sys_obj );
        
        // 线
        var lines_geometry = new THREE.Geometry();
        
        lines_geometry.vertices.push( new THREE.Vector3( position_x, position_y + 650 + 700 + 2400, position_z + 200) );
        ...
        //lines_geometry.vertices.push( new THREE.Vector3( position_x, position_y + 650 + 700 + 2400, position_z + 200) );
        //lines_geometry.vertices.push( new THREE.Vector3( position_x - 4500, position_y + 600 + 1000, position_z - 800 ) );
        ...
        //lines_geometry.vertices.push( new THREE.Vector3( position_x, position_y + 650 + 700 + 2400, position_z + 200) );
        //lines_geometry.vertices.push( new THREE.Vector3( position_x + 4500, position_y + 600 + 1000, position_z + 1700 ) );
    ...
    ClassTPlatform.prototype.loadTest1 = function(geometry){
        var sys_color = 0x00ff00;
        ...
        var sample_storage1 = THREE.SceneUtils.createMultiMaterialObject( geometry, sample_storage_material );
        sample_storage1.position.set(-10000, 1000, 20000);
        sample_storage1.scale.set( 1000, 200, 1000 );
        this.scene.add( sample_storage1 );
    }
    
    ClassTPlatform.prototype.loadTest2 = function(geometry){
        var sys_color = 0x00ff00;
        ...
        var sample_storage1 = THREE.SceneUtils.createMultiMaterialObject( geometry, sample_storage_material );
        sample_storage1.position.set(-10000, 1000, 10000);
        sample_storage1.scale.set( 100, 100, 100 );
        this.scene.add( sample_storage1 );
    }
