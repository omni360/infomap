...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadSenseObjects = function(){
        ...
        */
        ...
        mesh = new THREE.Mesh( new THREE.CubeGeometry( 8000, 0, 6000 ), new THREE.MeshFaceMaterial( materials ) );
        mesh.position = new THREE.Vector3(
            0,200,0
        );
        mesh.overdraw = true;
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        // 多个圆柱
        var plane_material = new THREE.MeshBasicMaterial( { color: 0x00ff00, wireframe: false} );
        for( var a = 0; a < 100; a ++ ) {
            var cylinderGeo = new THREE.CylinderGeometry( 20, 20, 10*a, 100, 100 );
