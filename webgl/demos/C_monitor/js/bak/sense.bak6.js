...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        var particle_material1 = new THREE.ParticleBasicMaterial( { size: 3, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry2 = new THREE.Geometry();
        var particle_colors2 = [];
        particle_geometry2.colors = particle_colors2;
        var particle_material2 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry3 = new THREE.Geometry();
        var particle_colors3 = [];
        particle_geometry3.colors = particle_colors3;
        var particle_material3 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry4 = new THREE.Geometry();
        var particle_colors4 = [];
        particle_geometry4.colors = particle_colors4;
        var particle_material4 = new THREE.ParticleBasicMaterial( { size: 3, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry5 = new THREE.Geometry();
        var particle_colors5 = [];
        particle_geometry5.colors = particle_colors5;
        var particle_material5 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry6 = new THREE.Geometry();
        var particle_colors6 = [];
        particle_geometry6.colors = particle_colors6;
        var particle_material6 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry7 = new THREE.Geometry();
        var particle_colors7 = [];
        particle_geometry7.colors = particle_colors7;
        var particle_material7 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry8 = new THREE.Geometry();
        var particle_colors8 = [];
        particle_geometry8.colors = particle_colors8;
        var particle_material8 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        
        particle_geometry9 = new THREE.Geometry();
        var particle_colors9 = [];
        particle_geometry9.colors = particle_colors9;
        var particle_material9 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            */
            ...
            var sprite = this.createTip(sprite_width, 200, 60, data_list[i][0] ,0xff0000, "center");
        ...
        Particles2 = new THREE.ParticleSystem( particle_geometry2, particle_material1 );
    ...
    ClassTPlatform.prototype.StartCartoon = function(){
        ...
        */
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            if(the_height > this.cartoon_index*10){
                ...
                var sprite_position = new THREE.Vector3(
                    this.sprite_li[i].position.x, this.cartoon_index*10 + 400, this.sprite_li[i].position.z
                );
