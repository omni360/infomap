...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        var woundedColors = [];
        killedGeometry.colors = woundedColors;
        var killedMaterial = new THREE.ParticleBasicMaterial( { size: 3, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        //var killedMaterial = new THREE.ParticleBasicMaterial( { size: 30, blending: THREE.NormalBlending, depthTest: true, transparent : true, map: sprite, vertexColors: true } );
        
        
        particle_geometry1 = new THREE.Geometry();
        var particle_colors1 = [];
        particle_geometry1.colors = particle_colors1;
        var particle_material1 = new THREE.ParticleBasicMaterial( { size: 6, sizeAttenuation:false, blending: THREE.AdditiveBlending, map: sprite, vertexColors: true } );
        ...
        // var data_color1 = 0xDE2F6F;
        // var data_color2 = 0x57A0DD;
        // var data_color3 = 0xB78380;
        // var data_color4 = 0x7C00FF;
        // var data_color5 = 0x3A4EAF;
        // var data_color6 = 0x6D93B5;
        // var data_color7 = 0x57D3CA;
        // var data_color8 = 0x48EFBF;
        // var data_color9 = 0x2979ED;
        var data_color1 = 0xDE2F6F;
        var data_color2 = 0xFFFF00;
        var data_color3 = 0xFF0033;
        var data_color4 = 0x663399;
        var data_color5 = 0x33CC99;
        var data_color6 = 0x990066;
        var data_color7 = 0xFF6600;
        var data_color8 = 0x48EFBF;
        var data_color9 = 0x0000ff;
        ...
        var text_li = [
            [22000, 3000, 2600, "textures/hlj.png"],
            [15000, 4500, 2600, "textures/jilin.png"],
            [29000, 4500, 2600, "textures/liaoning.png"],
            [15000, 4500, 2600, "textures/tianjin.png"],
            [29000, 4500, 2600, "textures/beijing.png"],
            [15000, 4500, 3000, "textures/beijingzx.png"],
            [29000, 4500, 2600, "textures/hebei.png"],
            [15000, 4500, 2600, "textures/nmg.png"],
            [29000, 4500, 2600, "textures/shanxi.png"],
            [15000, 4500, 2600, "textures/henan.png"],
            [29000, 4500, 2600, "textures/shandong.png"],
            [3000, 3000, 2600, "textures/jiangsu.png"],
            [-13000, 3000, 2600, "textures/shanghai.png"],
            [-5000, 2500, 2600, "textures/zhejiang.png"],
            [-7200, 2500, 2600, "textures/anhui.png"],
            [-7200, 3500, 2600, "textures/hubei.png"],
            [-7200, 3000, 2600, "textures/shanxi.png"],
            [-7200, 3000, 2600, "textures/ningxia.png"],
            [-600, 3000, 2600, "textures/gansu.png"],
            [-25000, 4500, 2600, "textures/qinghai.png"],
            [-35000, 4500, 2600, "textures/sichuan.png"],
            [-25000, 4500, 2600, "textures/chongqing.png"],
            [-35000, 4500, 2600, "textures/guizhou.png"],
            [-25000, 4500, 2600, "textures/hunan.png"],
            [-35000, 4500, 2600, "textures/jiangxi.png"],
            [-25000, 4500, 2600, "textures/fujian.png"],
            [-35000, 4500, 2600, "textures/guangdong.png"],
            [-25000, 4500, 2600, "textures/hainan.png"],
            [-35000, 4500, 2600, "textures/guangxi.png"],
            [-25000, 4500, 2600, "textures/yunnan.png"],
            [-35000, 4500, 2600, "textures/xizang.png"],
            [-2700, 6500, 2600, "textures/xinjiang.png"],
        ];
        
        
        // var data_1_height = 800;
        // var data_2_height = 1200;
        // var data_3_height = 1600;
        // var data_4_height = 2000;
        // var data_5_height = 2400;
        // var data_6_height = 2800;
        // var data_7_height = 3200;
        // var data_8_height = 3600;
        // var data_9_height = 4000;
        var data_1_height = 600;
        var data_2_height = 800;
        var data_3_height = 1000;
        var data_4_height = 1200;
        var data_5_height = 1400;
        var data_6_height = 1600;
        var data_7_height = 1800;
        var data_8_height = 2000;
        var data_9_height = 2200;
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            if(data_list[i][0] == '北京(国家中心)'){
                var cube_geometry = new THREE.CubeGeometry( 20, 2600, 20, 0, 0 );
                var cube_y = 1560;
                var cube_material = new THREE.MeshBasicMaterial( { color: 0xff0000, wireframe: false} );
                var sprite_width = 1000;
            }
            else{
                var cube_geometry = new THREE.CubeGeometry( 10, 2200, 10, 0, 0 );
                var cube_y = 1360;
                var cube_material = new THREE.MeshBasicMaterial( { color: 0x4A8F88, wireframe: false} );
            ...
            */
            ...
            if(data_list[i][1]){
                circle_r = data_list[i][1]*3;
                temp_s_d = 360/data_list[i][1];
                
                for( var j = 0; j < data_list[i][1]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_1_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    woundedColors.push(new THREE.Color( data_color1 ));
            ...
            if(data_list[i][9]){
                circle_r = data_list[i][9]*20;
                temp_s_d = 360/data_list[i][9];
                
                for( var j = 0; j < data_list[i][9]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_2_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color2 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            
            
            if(data_list[i][2]){
                circle_r = data_list[i][2]*20;
                temp_s_d = 360/data_list[i][2];
                
                for( var j = 0; j < data_list[i][2]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_3_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color3 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            if(data_list[i][4]){
                circle_r = data_list[i][4]*2;
                temp_s_d = 360/data_list[i][4];
                
                for( var j = 0; j < data_list[i][4]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_4_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    woundedColors.push(new THREE.Color( data_color4 ));
            ...
            if(data_list[i][5]){
                circle_r = data_list[i][5]*20;
                temp_s_d = 360/data_list[i][5];
                
                for( var j = 0; j < data_list[i][5]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_5_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color5 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            if(data_list[i][6]){
                circle_r = data_list[i][6]*20;
                temp_s_d = 360/data_list[i][6];
                
                for( var j = 0; j < data_list[i][6]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_6_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color6 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            if(data_list[i][7]){
                circle_r = data_list[i][7]*20;
                temp_s_d = 360/data_list[i][7];
                
                for( var j = 0; j < data_list[i][7]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_7_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color7 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            if(data_list[i][8]){
                circle_r = data_list[i][8]*20;
                temp_s_d = 360/data_list[i][8];
                
                for( var j = 0; j < data_list[i][8]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_8_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color8 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            if(data_list[i][3]){
                circle_r = data_list[i][3]*20;
                temp_s_d = 360/data_list[i][3];
                
                for( var j = 0; j < data_list[i][3]; j ++ ) {
                    var vector = this.getCoordinate(cx, data_9_height, cy, 0, temp_s_d*(j + 1), circle_r);
                    
                    particle_colors1.push(new THREE.Color( data_color9 ));
                    particle_geometry1.vertices.push(  vector  );
                }
            }
            ...
            */
            ...
            sprite.position.set( cx, text_li[i][2], cy );
            sprite.scale.set( sprite_width, 200, 1 );
            sprite.opacity = 1;
        ...
        var sys_text_li = [
            [data_1_height, "textures/system_name/bwjc.png",'报文监测和恶意代码捕获系统', 1200, 200, "60"],
            ...
            [data_4_height, "textures/system_name/eydmfx.png",'恶意代码分析系统', 1200, 200, "60"],
        ...
        for(i=0; i < sys_text_li.length; i++){
            ...
            var sprite = this.createTip(sys_text_li[i][3],sys_text_li[i][4],sys_text_li[i][5],sys_text_li[i][2] ,0xff0000);
        ...
        this.scene.add( killedParticles );
        ...
        var glowSpanTexture = THREE.ImageUtils.loadTexture('images/red_glowspan.png');
        var cylinderMaterial = new THREE.MeshBasicMaterial({
            map: glowSpanTexture,
            blending: THREE.AdditiveBlending,
            transparent: true,
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            var cube_geometry = new THREE.CubeGeometry( 40, 20, 40, 0, 0 );
            var mesh = new THREE.Mesh( cube_geometry, cube_material );
            mesh.position = new THREE.Vector3(
                cx,210,cy
            );
            ...
            // 飞碟
            var cylinderGeo = new THREE.CylinderGeometry( data_list[i][10] * 2, 20, data_list[i][10] / 2, Math.round(data_list[i][10]/4), 0 );
            var mesh = new THREE.Mesh( cylinderGeo, cylinderMaterial );
            mesh.material.map.wrapS = THREE.RepeatWrapping;
            mesh.material.map.wrapT = THREE.RepeatWrapping;
            mesh.material.map.needsUpdate = true;
    ...
    ClassTPlatform.prototype.StartCartoon = function(){
        ...
        */
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            if(data_list[i][10]*6 > this.cartoon_index*10){
                data_list[i][15].vertices[ 0 ].y = this.cartoon_index*10;
                data_list[i][15].vertices[ 1 ].y = this.cartoon_index*10;
                data_list[i][15].vertices[ 4 ].y = this.cartoon_index*10;
                data_list[i][15].vertices[ 5 ].y = this.cartoon_index*10;
                
                data_list[i][16].geometry.verticesNeedUpdate = true;
            }
            else{
                //console.info(this.rotating_li[i]);
       ...
       this.rotating.traverse(function (tt) {
            if (tt.update !== undefined) {
                tt.update();
            }
        });
    ...
    ClassTPlatform.prototype.createTip = function( width, height, font_size, para, color) {
