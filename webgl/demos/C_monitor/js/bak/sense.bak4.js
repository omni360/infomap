        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            if(data_list[i][1]){
                ...
                for( var j = 0; j < data_list[i][1]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0xDE2F6F ));
            ...
            if(data_list[i][2]){
                ...
                for( var j = 0; j < data_list[i][2]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x57A0DD ));
            ...
            if(data_list[i][3]){
                ...
                for( var j = 0; j < data_list[i][3]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x2979ED ));
            ...
            if(data_list[i][4]){
                ...
                for( var j = 0; j < data_list[i][4]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x7C00FF ));
            ...
            if(data_list[i][5]){
                ...
                for( var j = 0; j < data_list[i][5]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x3A4EAF ));
            ...
            if(data_list[i][6]){
                ...
                for( var j = 0; j < data_list[i][6]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x6D93B5 ));
            ...
            if(data_list[i][7]){
                ...
                for( var j = 0; j < data_list[i][7]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x57D3CA ));
            ...
            if(data_list[i][8]){
                ...
                for( var j = 0; j < data_list[i][8]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0x48EFBF ));
            ...
            if(data_list[i][9]){
                ...
                for( var j = 0; j < data_list[i][9]; j ++ ) {
                    ...
                    woundedColors.push(new THREE.Color( 0xB78380 ));
