...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        */
        ...
        // 根据数据绘制
        var cube_material = new THREE.MeshBasicMaterial( { color: 0x3DD6D4, wireframe: false} );
        ...
        for( var i = 0; i < data_list.length; i ++ ) {
            ...
            var cylinderGeo = new THREE.CylinderGeometry( data_list[i][10] * 2, 0, 0, Math.round(data_list[i][10]/4), 0 );
