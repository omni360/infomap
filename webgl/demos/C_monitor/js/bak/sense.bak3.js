...
function ClassTPlatform(settings){
    ...
    ClassTPlatform.prototype.loadChinaModel = function(geometry){
        var tube_material = new THREE.MeshBasicMaterial( { color: 0x9BCD9B, opacity: 0.8, wireframe: false, transparent: true } );
        var zmesh = new THREE.Mesh( geometry, tube_material );
        zmesh.position = new THREE.Vector3(
            0,200,0
        );
        zmesh.scale.set( 1000, 1000, 1);
    ...
    ClassTPlatform.prototype.loadTPlatformObject = function(){
        ...
        var cylinderGeo = new THREE.CylinderGeometry( 200, 100, 0, 100, 100 );
